...
if not st.sidebar.checkbox('Close', True, key = '1'):
    st.markdown('### Tweet location based on time of the day')
...
choice = st.sidebar.multiselect('Pick Airlines', ['US Airways', 'United', 'American', 'Southwest', 'Delta', 'Virgin America'], key = '2')
